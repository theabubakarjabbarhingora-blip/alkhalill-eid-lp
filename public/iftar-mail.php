                        ...
                        <tr>
                            <td class="mobile-padding" style="padding:40px 30px;">
                                ...
                                <p style="margin:0 0 20px;color:#4a5568;">
                                    Thank you for your generous contribution to our <strong>Iftar Box Campaign</strong>. Your support helps us provide nutritious Iftar meals to those in need during this blessed month of Ramadan.
                                </p>
                                <p class="urdu-text" style="margin:0 0 25px;font-size:20px;line-height:34px;text-align:right;color:#0d467e;border-right: 3px solid #f8a81a;padding-right: 15px;word-break:break-word;">
                                    ہماری افطار مہم میں آپ کے تعاون کا بہت شکریہ۔ آپ کا یہ عطیہ رمضان کے اس بابرکت مہینے میں مستحقین تک افطار پہنچانے میں ہماری مدد کرے گا۔
                                </p>
                                ...
                                <div style="background-color:#f8f9fa;border:1px solid #e2e8f0;border-radius:8px;padding:0;margin-bottom:30px;overflow:hidden;">
                                    ...
                                    <div style="padding:20px;">
                                        <table role="presentation" style="width:100%;border:none;border-spacing:0;">
                                            ...
                                            <tr>
                                                <td style="padding:8px 0;border-top:1px dashed #e2e8f0;font-size:15px;color:#718096;">No. of Boxes / <span class="urdu-text">باکس</span></td>
                                ...
                                <div style="text-align:center;padding:30px 20px;background-color:#fffbf2;border-radius:8px;border:1px solid #ffeeba;margin-bottom:25px;position:relative;">
                                    ...
                                    <p class="serif-text" style="margin:0 0 15px;font-size:18px;line-height:28px;color:#555;font-style:italic;">
                                        "Whoever provides Iftar for a fasting person will have a reward like theirs, without that detracting from the reward of the fasting person in the slightest."
                                    </p>
                                    <p class="urdu-text" style="margin:0 0 10px;font-size:22px;line-height:36px;color:#0d467e;">
                                        "جو شخص کسی روزہ دار کا روزہ افطار کرائے گا تو اس کے لیے بھی اتنا ہی اجر ہے جتنا روزہ دار کے لیے۔"
                                    </p>
                                    <p style="margin:10px 0 0;font-size:12px;color:#a0aec0;text-transform:uppercase;letter-spacing:1px;font-weight:600;">— Sunan Tirmidhi</p>
                                </div>
...
$headers = [];
$headers[] = "From: Iftar Campaign <info@alkhalilwelfare.org>";
...
$adminSubject = "New Iftar Donation Form Submission";
$sentAdmin = mail($adminTo, $adminSubject, $adminHtml, $headersStr);

$userTo = $email;
$userSubject = "Thank you for your Iftar donation";
